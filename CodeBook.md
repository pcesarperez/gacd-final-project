...
The rest of the variable names are composed using a series of items, separated by a dot character, preferring long names to compact and cryptic ones, described as follows:
